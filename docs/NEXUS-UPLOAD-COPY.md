...
```text
A read-only Project Zomboid interactive map showing game-derived towns, streets, businesses, filters, coordinates, navigation, and custom markers.
```
...
```text
Knox Atlas 0.1.0 — Windows Installer
```
